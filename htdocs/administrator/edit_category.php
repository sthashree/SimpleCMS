<?php 
	...
	$category = $cat_obj->Find(null,$_GET['category']);
...
<html>
	...
	<body>
		...
		<div id="conteiner">
			...
			<div id="body">		
			<h2> <?php echo $t->translate('category/edit-title');?> </h2>	
...
<fieldset>
	<label for="category_name" class="required"><?php echo $t->translate('category/category-label'); ?></label>
		<input type="text" id="category_name" name="data[Category][category_name]" tabindex="1" size="40" value="<?php echo $category->category_name; ?>" title="category_name"><br>

<label for="unique_name" class="required"><?php echo $t->translate('label-unique-name'); ?></label>
		<input type="text" id="unique_name" name="data[Category][category_unique_name]" tabindex="2" size="40" value="<?php echo $category->category_unique_name; ?>" title="unique_name"><br>

	<label for="cat_description" class="required"><?php echo $t->translate('label-description'); ?></label>
		<textarea name="data[Category][description]" cols="40" id="cat_description" tabindex="3" title="cat_description"><?php echo $category->description; ?></textarea>
		<br>
</fieldset>
<input type="hidden" name="action" value="update"/><!-- -->
<input type="hidden" name="category" value="<?php echo $category->id; ?>"/>
<input type="submit" value="<?php echo $t->translate('category/btn-update'); ?>" id="submit" tabindex="4">
