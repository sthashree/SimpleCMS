...
(Click on next button after completing all uploads )<br />
<input type="button" value="Next >>" onclick="document.location='chirasi.php?extra=finalchirasi'"  />
...
$(function(){
	...
	$('#swfupload-control').swfupload({
		upload_url: "chirasi/upload-file.php",
		file_post_name: 'uploadfile',
		file_size_limit : "5000000",
		file_types : "*.jpg;*.png;*.gif;*.pdf;*.doc;*.docx",
