...
<div id="swfupload-control">
	<p>最大５つの画像をアップしてください。それぞれ2MBのサイズにしてください。</p>
	<input type="button" id="button" />
	<p id="queuestatus" ></p>
	<ol id="log"></ol>
</div>
(アップロードが完了したら次へ押してください。 )<br />
<input type="button" value="Next >>" onclick="document.location='gallery.php?extra=finalphoto&gallery=<?=$gallery;?>'"  />
...
$(function(){
	...
	$('#swfupload-control').swfupload({
		...
		upload_url: "gallery/upload-file.php?gallery="+gallery,
		...
		.bind('fileDialogComplete', function(event, numFilesSelected, numFilesQueued){
			$('#queuestatus').text('ファイルが選択されました: '+numFilesSelected+' / Queued Files: '+numFilesQueued);
		})
		...
		.bind('uploadSuccess', function(event, file, serverData){
			...
			var pathtofile='<a href="photo/resized/'+file.name+'" target="_blank" >&nbsp;</a>';
