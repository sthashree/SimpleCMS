			...
			<h2> <?php echo $t->translate('myblog/addcategory-title');?> </h2>	
	...
	<label for="title" class="required"><?php echo $t->translate('myblog/category-title'); ?></label>
		<input type="text" id="title" name="data[Blog][category_name]" tabindex="1" size="50" value="" title="filesize"><br/>
	...
	<label for="titlealias" class="required"><?php echo $t->translate('myblog/category-title-alias'); ?></label>
		<input type="text" id="blogname_alias" name="data[Blog][category_name_alias]" tabindex="2" size="50" value="" title="blogname_alias"><br/>
	<label for="description" class="required"><?php echo $t->translate('desc'); ?></label>	
	<table><tr><td style="padding-left:8px"><textarea name="data[Blog][category_description]" cols="55" id="category_description" tabindex="7" title="category_description"></textarea>
</td></tr></table>	
		...
		<select name="data[Gallery][published]" id="publish" tabindex="10">
