...
class Product extends DBObject  {
	...
	function FindCategory() {
		return $this->SearchCustom($this->_uses,"parent_id=0 and publish=1 and category_description !='bentou'","","ordering asc");
	...
	function getProductByCategory($cat,$limit)
	{
		$where ="category_id='$cat' and publish='1'";
		return $this->SearchProduct($where,$limit);
